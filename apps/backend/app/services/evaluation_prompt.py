...
- Если в ответе есть формулы, математический вывод или код — проверяй их ПО ШАГАМ: указывай, где именно ошибка в рассуждении, а не только в итоге. Формулы в своём фидбэке пиши в LaTeX ($...$ инлайн, $$...$$ блочные).
